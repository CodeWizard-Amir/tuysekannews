    ...
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <p class="text-2xl md:text-3xl font-light leading-normal"> صفحه مورد نظر شما پیدا نشد </p>
                <p class="mb-8">یا صفحه پاک شده یا اصلا وجود نداشته است</p>

                <a href="{{ route('websitepages.home') }}"
