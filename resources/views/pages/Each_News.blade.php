...
@section('title', "اخبار | $news?->title ")
            ...
            <div class="w-full md:w-[48%] xl:w-full mb-5 !h-fit shadow-sm border border-gray-100">
                ...
                <ul class="p-5">
                    @foreach ($celebritise as $celebrity)
                        ...
                        <li class="my-2 flex justify-between items-center py-3">
                            <a class="text-sm hover:text-orange-800 flex justify-center items-center" href="{{route('websitepages.celebrity',['celebrityID'=>$celebrity->celebrityID,'name'=> str_replace(' ',"-",$celebrity->name)])}}">
