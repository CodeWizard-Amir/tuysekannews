...
@section('body')
    <section class="p-5">
        ...
        <div class="my-5 w-full border-t-2 border-red-500 bg-white p-10">
            <form class="w-full space-y-5 px-10" action="{{route("create.news")}}" method="POST" enctype="multipart/form-data">
                @csrf
                <input name="title" class="w-full shadow-sm rounded-sm px-5 py-3 border border-gray-200" type="text"
                    placeholder="عنوان خبر (حداکثر 255 کاراکتر)">
                ...
                <br>
                <span class="my-2 mx-1">تصویر اصلی خبر</span>
                <div
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-gray-100">
                        <td class="border-2 text-center p-2 border-gray-300">
                            <img class="w-14 h-14 rounded-full !mx-auto" src="{{url('/')}}/{{$news->picture}}" alt="">
                        </td>
