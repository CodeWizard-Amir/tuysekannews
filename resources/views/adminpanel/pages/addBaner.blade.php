...
@section('body')
    <section class="p-5">
        ...
        <div class="my-5 w-full border-t-2 border-red-500 bg-white p-10">
            <form class="w-full space-y-5 px-10" action="{{route("create.baner")}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input title="لینکی که وارد میکنید میشود ادرس این تصویر تا زمان کلیک بر روی ان به ان ادرس برود" name="link" class="w-[48%] shadow-sm rounded-sm px-5 py-3 border border-gray-200" type="text"
                    placeholder="لینک تصویر (در صورت وجود)">
                    <br>
                    <br>
                    <span class="mx-1">تصویر بنر </span>

                    <div class="flex !hidden imgperveiw relative justify-center [&_>svg]:hover:text-purple-800 items-center w-full h-96 border border-gray-200 shadow-md cursor-pointer rounded-md">
            ...
            <table class="w-full border-2 border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-gray-100 border-2 border-gray-300">
                        ...
                        <td class=" flex justify-center items-center text-center p-2"><img class="w-24 h-12" src="{{$baner->picture}}" alt=""></td>
                        <td class="border-2 text-center p-2 border-gray-300"><a class="text-blue-500" href="{{$baner->link !="nothing" ? $baner->link : "#"}}">لینک</a></td>
